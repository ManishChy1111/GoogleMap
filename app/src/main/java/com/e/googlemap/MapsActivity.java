...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        latLngs.add(new LatitudeLongitude(27.705234, 85.3294158, "Softwarica College"));
        latLngs.add(new LatitudeLongitude(27.70482, 85.3293997, "Gopal Dai Ko Chatamari and Momo Center"));
        latLngs.add(new LatitudeLongitude(27.7056933, 85.3300743, "Jin Kazama"));
